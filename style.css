let dummyMenu = {
    1: { item: "Noodles", price: 60, count:0},
    2: { item: "Dosa", price: 40, count:0},
    3: { item: "VadaPav", price: 30, count:0},
    4: {item: "Lassi", price: 20, count:0},
    5: {item: "MisalPav", price: 50, count:0},
    6: {item: "Sandwich", price:40, count:0}
};
